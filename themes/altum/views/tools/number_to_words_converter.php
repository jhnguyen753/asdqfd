...
<?php endif ?>
    ...
    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 text-truncate">
            <h1 class="h4 m-0 text-truncate"><?= l('tools.number_to_words_converter.name') ?></h1>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    <label for="number"><i class="fas fa-fw fa-sort-numeric-up-alt fa-sm text-muted mr-1"></i> <?= l('tools.number_to_words_converter.number') ?></label>
                ...
                <div class="form-group">
                    ...
                    <select id="language" name="language" class="custom-select <?= \Altum\Alerts::has_field_errors('language') ? 'is-invalid' : null ?>" required="required">
