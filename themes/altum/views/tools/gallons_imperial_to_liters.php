...
<?php endif ?>
    ...
    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 text-truncate">
            <h1 class="h4 m-0 text-truncate"><?= l('tools.gallons_imperial_to_liters.name') ?></h1>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    <label for="gallons"><i class="fas fa-fw fa-tint fa-sm text-muted mr-1"></i> <?= l('tools.gallons_imperial_to_liters.gallons') ?></label>
