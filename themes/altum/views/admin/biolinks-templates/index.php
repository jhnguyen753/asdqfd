                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            <?php if($row->image): ?>
                                <a href="<?= url('admin/biolink-template-update/' . $row->biolink_template_id) ?>" class="mr-3">
                                    <img src="<?= \Altum\Uploads::get_full_url('biolinks_templates') . $row->image ?>" class="user-avatar rounded-circle" alt="" />
                                </a>
                            <?php endif ?>
                    ...
                    <td class="text-nowrap">
                        <span class="mr-2" data-toggle="tooltip" data-html="true" title="<?= l('admin_biolinks_templates.biolink_template_id') . '<br />' . $row->biolink_template_id ?>">
