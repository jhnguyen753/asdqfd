    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= get_max_upload() ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), get_max_upload()) ?>">
                ...
                <?= include_view(THEME_PATH . 'views/partials/file_image_input.php', ['uploads_file_key' => 'biolinks_themes', 'file_key' => 'image', 'already_existing_image' => null]) ?>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="px">
                ...
                <input id="biolink_background_blur" type="range"  min="0" max="30" class="form-control" name="biolink_background_blur" value="<?= $data->values['biolink_background_blur'] ?>" />
            </div>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="%">
                ...
                <input id="background_brightness" type="range"  min="0" max="150" class="form-control" name="background_brightness" value="<?= $data->values['biolink_background_brightness'] ?>" />
            </div>
            ...
            <div class="form-group">
                ...
                <input id="biolink_block_text_color" type="color" name="biolink_block_text_color" class="form-control" value="<?= $data->values['biolink_block_text_color'] ?>" required="required" />
            </div>
            ...
            <div class="form-group">
                ...
                <input id="biolink_block_background_color" type="color" name="biolink_block_background_color" class="form-control" value="<?= $data->values['biolink_block_background_color'] ?>" required="required" />
            </div>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="px">
                ...
                <input id="biolink_block_border_width" type="range" min="0" max="5" class="form-control" name="biolink_block_border_width" value="<?= $data->values['biolink_block_border_width'] ?>" required="required" />
            </div>
            ...
            <div class="form-group">
                ...
                <input id="biolink_block_border_color" type="color" name="biolink_block_border_color" class="form-control" value="<?= $data->values['biolink_block_border_color'] ?>" required="required" />
            </div>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="px">
                ...
                <input id="biolink_block_border_shadow_offset_x" type="range" min="-20" max="20" class="form-control" name="biolink_block_border_shadow_offset_x" value="<?= $data->values['biolink_block_border_shadow_offset_x'] ?>" required="required" />
            </div>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="px">
                ...
                <input id="biolink_block_border_shadow_offset_y" type="range" min="-20" max="20" class="form-control" name="biolink_block_border_shadow_offset_y" value="<?= $data->values['biolink_block_border_shadow_offset_y'] ?>" required="required" />
            </div>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="px">
                ...
                <input id="biolink_block_border_shadow_blur" type="range" min="0" max="20" class="form-control" name="biolink_block_border_shadow_blur" value="<?= $data->values['biolink_block_border_shadow_blur'] ?>" required="required" />
            </div>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="px">
                ...
                <input id="biolink_block_border_shadow_spread" type="range" min="0" max="10" class="form-control" name="biolink_block_border_shadow_spread" value="<?= $data->values['biolink_block_border_shadow_spread'] ?>" required="required" />
            </div>
            ...
            <div class="form-group">
                ...
                <input id="biolink_block_border_shadow_color" type="color" name="biolink_block_border_shadow_color" class="form-control" value="<?= $data->values['biolink_block_border_shadow_color'] ?>" required="required" />
            </div>
