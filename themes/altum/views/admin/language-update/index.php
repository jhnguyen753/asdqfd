...
<?php if($data->type): ?>
<div style="position: fixed; right: 1rem; bottom: 1rem; z-index: 9999;">
    <div class="mb-2">
        <button type="button" class="btn btn-light" onclick="document.querySelector('h1').scrollIntoView({ behavior: 'smooth', block: 'center' });"><i class="fas fa-fw fa-arrow-up"></i></button>
    </div>
    <div>
        <button type="button" class="btn btn-light" onclick="document.querySelector(`button[type='submit']`).scrollIntoView({ behavior: 'smooth', block: 'center' });"><i class="fas fa-fw fa-arrow-down"></i></button>
    </div>
</div>
<?php endif ?>
