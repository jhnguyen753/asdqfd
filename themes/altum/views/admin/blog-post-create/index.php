            ...
            <div class="form-group">
                ...
                <div class="row btn-group-toggle" data-toggle="buttons">
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->values['editor'] == 'wysiwyg' ? 'active"' : null?>">
                    ...
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->values['editor'] == 'blocks' ? 'active"' : null?>">
                    ...
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->values['editor'] == 'raw' ? 'active"' : null?>">
