...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fas fa-fw fa-xs fa-palette text-primary-900 mr-2"></i> <?= l('admin_biolinks_themes.header') ?></h1>

    <div class="d-flex position-relative">
        <div class="">
            <a href="<?= url('admin/biolink-theme-create') ?>" class="btn btn-primary"><i class="fas fa-fw fa-plus-circle fa-sm mr-1"></i> <?= l('admin_biolink_theme_create.menu') ?></a>
        </div>
        ...
        <div class="ml-3">
            <div class="dropdown">
                <button type="button" class="btn <?= $data->filters->has_applied_filters ? 'btn-secondary' : 'btn-gray-300' ?> filters-button dropdown-toggle-simple" data-toggle="dropdown" data-boundary="viewport" data-tooltip title="<?= l('global.filters.header') ?>">
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    <div class="dropdown-header d-flex justify-content-between">
                        ...
                        <?php if($data->filters->has_applied_filters): ?>
                            <a href="<?= url('admin/biolinks-themes') ?>" class="text-muted"><?= l('global.filters.reset') ?></a>
                        <?php endif ?>
                    </div>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            <?php if($row->image): ?>
                                <a href="<?= url('admin/biolink-theme-update/' . $row->biolink_theme_id) ?>" class="mr-3">
                                    <img src="<?= \Altum\Uploads::get_full_url('biolinks_themes') . $row->image ?>" class="user-avatar rounded-circle" alt="" />
                                </a>
                            <?php endif ?>
                    ...
                    <td class="text-nowrap">
                        <span class="mr-2" data-toggle="tooltip" data-html="true" title="<?= l('admin_biolinks_themes.biolink_theme_id') . '<br />' . $row->biolink_theme_id ?>">
