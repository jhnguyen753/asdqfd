            ...
            <div data-image-container="image" class="<?= !empty($row->settings->image) ? null : 'd-none' ?>">
                <div class="row">
                    <div class="my-2 col-6 col-xl-4">
                        <img src="<?= $row->settings->image ? \Altum\Uploads::get_full_url('block_thumbnail_images') . $row->settings->image : null ?>" class="img-fluid rounded <?= !empty($row->settings->image) ? null : 'd-none' ?>" loading="lazy" />
                    </div>
                </div>
                <div class="custom-control custom-checkbox my-2">
