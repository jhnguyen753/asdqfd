    ...
    <form action="" method="post" role="form" enctype="multipart/form-data">
        ...
        <div class="flex-wrap mb-4 btn-group-toggle d-none d-lg-flex" data-toggle="buttons">
            <?php foreach($data->qr_code_settings['type'] as $key => $value): ?>
                <label class="mr-3 mb-3 btn btn-light <?= $data->qr_code->type == $key ? 'active' : null ?>" data-toggle="tooltip" title="<?= l('qr_codes.type.' . $key . '_description') ?>" data-tooltip-hide-on-click>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group d-lg-none">
                            ...
                            <select id="type" name="type" class="custom-select">
                                <?php foreach(array_keys($data->qr_code_settings['type']) as $type): ?>
                                    <option value="<?= $type ?>" <?= $data->qr_code->type == $type ? 'selected="selected"' : null ?>><?= $data->qr_code_settings['type'][$type]['emoji'] . ' ' . l('qr_codes.type.' . $type) ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        ...
                        <div>
                            <div class="form-group" data-type="url">
                                ...
                                <input type="url" id="url" name="url" class="form-control <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->url ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['url']['max_length'] ?>" required="required" placeholder="<?= l('global.url_placeholder') ?>" data-reload-qr-code />
                        ...
                        <div>
                            <div class="form-group" data-type="upi">
                                ...
                                <input type="text" id="upi_payee_id" name="upi_payee_id" class="form-control <?= \Altum\Alerts::has_field_errors('upi_payee_id') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->upi_payee_id ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['upi']['payee_id']['max_length'] ?>" required="required" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="upi">
                                ...
                                <input type="text" id="upi_payee_name" name="upi_payee_name" class="form-control <?= \Altum\Alerts::has_field_errors('upi_payee_name') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->upi_payee_name ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['upi']['payee_name']['max_length'] ?>" required="required" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="upi">
                                ...
                                <input type="text" id="upi_transaction_id" name="upi_transaction_id" class="form-control <?= \Altum\Alerts::has_field_errors('upi_transaction_id') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->upi_transaction_id ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['upi']['transaction_id']['max_length'] ?>" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="upi">
                                ...
                                <input type="text" id="upi_transaction_note" name="upi_transaction_note" class="form-control <?= \Altum\Alerts::has_field_errors('upi_transaction_note') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->upi_transaction_note ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['upi']['transaction_note']['max_length'] ?>" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="upi">
                                ...
                                <input type="url" id="upi_thank_you_url" name="upi_thank_you_url" class="form-control <?= \Altum\Alerts::has_field_errors('upi_thank_you_url') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->upi_thank_you_url ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['upi']['thank_you_url']['max_length'] ?>" data-reload-qr-code />
                        ...
                        <div>
                            <div class="form-group" data-type="epc">
                                ...
                                <input type="text" id="epc_iban" name="epc_iban" class="form-control <?= \Altum\Alerts::has_field_errors('epc_iban') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->epc_iban ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['epc']['iban']['max_length'] ?>" required="required" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="epc">
                                ...
                                <input type="text" id="epc_payee_name" name="epc_payee_name" class="form-control <?= \Altum\Alerts::has_field_errors('epc_payee_name') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->epc_payee_name ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['epc']['payee_name']['max_length'] ?>" required="required" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="epc">
                                ...
                                <input type="text" id="epc_bic" name="epc_bic" class="form-control <?= \Altum\Alerts::has_field_errors('epc_bic') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->epc_bic ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['epc']['bic']['max_length'] ?>" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="epc">
                                ...
                                <input type="text" id="epc_remittance_text" name="epc_remittance_text" class="form-control <?= \Altum\Alerts::has_field_errors('epc_remittance_text') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->epc_remittance_text ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['epc']['remittance_text']['max_length'] ?>" data-reload-qr-code />
                            ...
                            <div class="form-group" data-type="epc">
                                ...
                                <input type="text" id="epc_information" name="epc_information" class="form-control <?= \Altum\Alerts::has_field_errors('epc_information') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->epc_information ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['epc']['information']['max_length'] ?>" data-reload-qr-code />
                            ...
                            <div class="form-group">
                                ...
                                <div class="row btn-group-toggle" data-toggle="buttons">
                                    <?php foreach(['square' => 'fas fa-square-full', 'dot' => 'fas fa-circle', 'round' => 'fas fa-square', 'heart' => 'fas fa-heart', 'diamond' => 'fas fa-gem'] as $key => $icon): ?>
                                        <div class="col-6">
                                            <label class="btn btn-light btn-block <?= ($data->qr_code->settings->style) == $key ? 'active"' : null?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row btn-group-toggle" data-toggle="buttons">
                                    <?php foreach(['square' => 'fas fa-square-full', 'dot' => 'fas fa-circle', 'rounded' => 'fas fa-square', 'diamond' => 'fas fa-gem', 'flower' => 'fas fa-seedling', 'leaf' => 'fas fa-leaf'] as $key => $icon): ?>
                                        <div class="col-6">
                                            <label class="btn btn-light btn-block <?= ($data->qr_code->settings->inner_eye_style) == $key ? 'active"' : null?>">
                                                <input type="radio" name="inner_eye_style" value="<?= $key ?>" class="custom-control-input" <?= ($data->qr_code->settings->inner_eye_style) == $key ? 'checked="checked"' : null?> required="required" data-reload-qr-code />
                                                <i class="<?= $icon ?> fa-fw fa-sm mr-1"></i> <?= l('qr_codes.input.style.' . $key) ?>
                                            </label>
                                        </div>
                                    <?php endforeach ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row btn-group-toggle" data-toggle="buttons">
                                    <?php foreach(['square' => 'fas fa-square-full', 'circle' => 'fas fa-circle', 'rounded' => 'fas fa-square', 'flower' => 'fas fa-seedling', 'leaf' => 'fas fa-leaf'] as $key => $icon): ?>
                                        <div class="col-6">
                                            <label class="btn btn-light btn-block <?= ($data->qr_code->settings->outer_eye_style) == $key ? 'active"' : null?>">
                                                <input type="radio" name="outer_eye_style" value="<?= $key ?>" class="custom-control-input" <?= ($data->qr_code->settings->outer_eye_style) == $key ? 'checked="checked"' : null?> required="required" data-reload-qr-code />
                                                <i class="<?= $icon ?> fa-fw fa-sm mr-1"></i> <?= l('qr_codes.input.style.' . $key) ?>
                                            </label>
                                        </div>
                                    <?php endforeach ?>
                        ...
                        <div class="collapse" id="frame_container">
                            ...
                            <div class="form-group" data-range-counter>
                                ...
                                <input id="frame_text_size" type="range" min="-5" max="5" name="frame_text_size" value="<?= $data->qr_code->settings->frame_text_size ?>" class="form-control <?= \Altum\Alerts::has_field_errors('frame_text_size') ? 'is-invalid' : null ?>" data-reload-qr-code />
                            ...
                            <div class="form-group" data-frame-custom-colors="on">
                                ...
                                <input type="hidden" id="frame_color" name="frame_color" class="form-control <?= \Altum\Alerts::has_field_errors('frame_color') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->frame_color ?? '#000000' ?>" data-reload-qr-code data-color-picker />
                                <?= \Altum\Alerts::output_field_error('frame_color') ?>
                            </div>

                            <div class="form-group" data-frame-custom-colors="on">
                                <label for="frame_text_color"><?= l('qr_codes.input.frame_text_color') ?></label>
                                <input type="hidden" id="frame_text_color" name="frame_text_color" class="form-control <?= \Altum\Alerts::has_field_errors('frame_text_color') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->frame_text_color ?? '#ffffff' ?>" data-reload-qr-code data-color-picker />
                        ...
                        <div class="collapse" id="branding_container">
                            ...
                            <div class="form-group" data-range-counter>
                                ...
                                <input id="qr_code_logo_size" type="range" min="5" max="40" name="qr_code_logo_size" value="<?= $data->qr_code->qr_code_logo_size ?? 25 ?>" class="form-control <?= \Altum\Alerts::has_field_errors('qr_code_logo_size') ? 'is-invalid' : null ?>" data-reload-qr-code />
                                <?= \Altum\Alerts::output_field_error('qr_code_logo_size') ?>
                            </div>

                            <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= $data->qr_code_settings['qr_code_background_size_limit'] ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), $data->qr_code_settings['qr_code_background_size_limit']) ?>">
                            ...
                            <div class="form-group" data-range-counter data-range-counter-suffix="%">
                                ...
                                <input id="qr_code_background_transparency" type="range" min="0" max="100" step="10" name="qr_code_background_transparency" value="<?= $data->qr_code->settings->qr_code_background_transparency ?? 0 ?>" class="form-control <?= \Altum\Alerts::has_field_errors('qr_code_background_transparency') ? 'is-invalid' : null ?>" data-reload-qr-code />
