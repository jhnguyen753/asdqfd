    ...
    <div class="card-body">
        ...
        <?php if(count($data->filters_get)): ?>
            ...
            <div class="d-flex flex-column align-items-center justify-content-center py-4">
                ...
                <h2 class="h4 text-muted"><?= l('global.filters.no_data') ?></h2>
                <p class="text-muted mb-3"><?= l('global.filters.no_data_help') ?></p>
        ...
        <?php else: ?>
            ...
            <div class="d-flex flex-column align-items-center justify-content-center py-4">
                ...
                <h2 class="h4 text-muted"><?= l($data->name . '.no_data') ?></h2>

                <?php if($data->has_secondary_text): ?>
                    <p class="text-muted m-0"><?= l($data->name . '.no_data_help') ?></p>
                <?php endif ?>
            </div>
