...
class ApiQrCodes extends Controller {
    ...
    private function get_all() {
        ...
        $filters->set_default_order_by('qr_code_id', $this->api_user->preferences->default_order_type ?? settings()->main->default_order_type);
    ...
    private function post() {
        ...
        switch($_POST['type']) {
            ...
            case 'upi':
                ...
                $settings['upi_payee_id'] = $_POST['upi_payee_id'] = mb_substr(input_clean($_POST['upi_payee_id'] ?? null), 0, $qr_code_settings['type']['upi']['payee_id']['max_length']);
                $settings['upi_payee_name'] = $_POST['upi_payee_name'] = mb_substr(input_clean($_POST['upi_payee_name'] ?? null), 0, $qr_code_settings['type']['upi']['payee_name']['max_length']);
                ...
                $settings['upi_transaction_id'] = $_POST['upi_transaction_id'] = mb_substr(input_clean($_POST['upi_transaction_id'] ?? null), 0, $qr_code_settings['type']['upi']['transaction_id']['max_length']);
                $settings['upi_transaction_note'] = $_POST['upi_transaction_note'] = mb_substr(input_clean($_POST['upi_transaction_note'] ?? null), 0, $qr_code_settings['type']['upi']['transaction_note']['max_length']);
                $settings['upi_transaction_reference'] = $_POST['upi_transaction_reference'] = mb_substr(input_clean($_POST['upi_transaction_reference'] ?? null), 0, $qr_code_settings['type']['upi']['transaction_reference']['max_length']);
                $settings['upi_thank_you_url'] = $_POST['upi_thank_you_url'] = mb_substr(input_clean($_POST['upi_thank_you_url'] ?? null), 0, $qr_code_settings['type']['upi']['thank_you_url']['max_length']);
                break;
        }
        ...
        if($_POST['qr_code_background']) {
            ...
            if($_FILES['qr_code_background']['error'] == UPLOAD_ERR_INI_SIZE) {
                $this->response_error(sprintf(l('global.error_message.file_size_limit'), $qr_code_settings['qr_code_background_size_limit']), 401);
            }
        ...
        /* Clear the cache */
        \Altum\Cache::$adapter->deleteItem('qr_codes_total?user_id=' . $this->api_user->user_id);
    ...
    private function patch() {
        ...
        /* Settings & qr code */
        $settings = [];
        $settings['inner_eye_style'] = $_POST['inner_eye_style'] = isset($_POST['inner_eye_style']) && in_array($_POST['inner_eye_style'], ['square', 'dot', 'rounded', 'diamond', 'flower', 'leaf',]) ? $_POST['inner_eye_style'] : $qr_code->settings->inner_eye_style;
        $settings['outer_eye_style'] = $_POST['outer_eye_style'] = isset($_POST['outer_eye_style']) && in_array($_POST['outer_eye_style'], ['square', 'circle', 'rounded', 'flower', 'leaf',]) ? $_POST['outer_eye_style'] : $qr_code->settings->outer_eye_style;
        $settings['style'] = $_POST['style'] = isset($_POST['style']) && in_array($_POST['style'], ['square', 'dot', 'round', 'diamond', 'heart']) ? $_POST['style'] : $qr_code->settings->style;
        ...
        $_POST['qr_code_background'] = !empty($_FILES['qr_code_background']['name']) && !(int) isset($_POST['qr_code_background_remove']);
        $settings['qr_code_background_transparency'] = $_POST['qr_code_background_transparency'] = isset($_POST['qr_code_background_transparency']) && in_array($_POST['qr_code_background_transparency'], range(0, 100)) ? (int) $_POST['qr_code_background_transparency'] : $qr_code->settings->qr_code_background_transparency;
        ...
        $settings['custom_frame_colors'] = $_POST['custom_frame_colors'] = (int) ($_POST['custom_frame_colors'] ?? $qr_code->settings->custom_frame_colors);
        if($_POST['custom_frame_colors']) {
            $settings['frame_color'] = $_POST['frame_color'] = !preg_match('/#([A-Fa-f0-9]{3,4}){1,2}\b/i', $_POST['frame_color']) ? $qr_code->settings->frame_color : $_POST['frame_color'];
            $settings['frame_text_color'] = $_POST['frame_text_color'] = !preg_match('/#([A-Fa-f0-9]{3,4}){1,2}\b/i', $_POST['frame_text_color']) ? $qr_code->settings->frame_text_color : $_POST['frame_text_color'];
        }
        ...
        switch($_POST['type']) {
            ...
            case 'upi':
                $settings['upi_payee_id'] = $_POST['upi_payee_id'] = mb_substr(input_clean($_POST['upi_payee_id'] ?? $qr_code->settings->upi_payee_id), 0, $qr_code_settings['type']['upi']['payee_id']['max_length']);
                $settings['upi_payee_name'] = $_POST['upi_payee_name'] = mb_substr(input_clean($_POST['upi_payee_name'] ?? $qr_code->settings->upi_payee_name), 0, $qr_code_settings['type']['upi']['payee_name']['max_length']);
                $settings['upi_currency'] = $_POST['upi_currency'] = in_array($_POST['upi_currency'], ['INR']) ? $_POST['upi_currency'] : 'INR';
                $settings['upi_amount'] = isset($_POST['upi_amount']) ? (float) $_POST['upi_amount'] : $qr_code->settings->upi_amount;
                $settings['upi_transaction_id'] = $_POST['upi_transaction_id'] = mb_substr(input_clean($_POST['upi_transaction_id'] ?? $qr_code->settings->upi_transaction_id), 0, $qr_code_settings['type']['upi']['transaction_id']['max_length']);
                $settings['upi_transaction_note'] = $_POST['upi_transaction_note'] = mb_substr(input_clean($_POST['upi_transaction_note'] ?? $qr_code->settings->upi_transaction_note), 0, $qr_code_settings['type']['upi']['transaction_note']['max_length']);
                $settings['upi_transaction_reference'] = $_POST['upi_transaction_reference'] = mb_substr(input_clean($_POST['upi_transaction_reference'] ?? $qr_code->settings->upi_transaction_reference), 0, $qr_code_settings['type']['upi']['transaction_reference']['max_length']);
                $settings['upi_thank_you_url'] = $_POST['upi_thank_you_url'] = mb_substr(input_clean($_POST['upi_thank_you_url'] ?? $qr_code->settings->upi_thank_you_url), 0, $qr_code_settings['type']['upi']['thank_you_url']['max_length']);
                break;
